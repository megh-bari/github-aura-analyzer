    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-black relative">
      ...
      <header className="p-4 sm:p-6 max-w-7xl mx-auto">
        ...
        <nav className="flex justify-between items-center">
          <div className="flex items-center space-x-3 sm:space-x-3 group cursor-pointer">
            {" "}
            {/* Adjusted space for mobile */}
            <Github className="w-6 h-6 sm:w-7 sm:h-7 text-purple-400 group-hover:rotate-12 transition-transform duration-300" />{" "}
            {/* Increased size for mobile */}
            <div className="text-xl sm:text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500 whitespace-nowrap">
              {" "}
